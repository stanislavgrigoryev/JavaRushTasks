...
public class CommandExecutor {
    ...
    public static void execute(Operation operation) throws Exception {
        for (Map.Entry<Operation, Command> operationCommandEntry : ALL_KNOWN_COMMANDS_MAP.entrySet()) {
            if (operationCommandEntry.getKey().equals(operation)){
                operationCommandEntry.getValue().execute();
            }
        }
    }
}
