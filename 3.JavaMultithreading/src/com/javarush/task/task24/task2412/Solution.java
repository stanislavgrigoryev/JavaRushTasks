    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            ...
            public int compare(Stock o1, Stock o2) {
                Double change1 = o1.containsKey("change") ?
                        (Double) o1.get("change") : (Double) o1.get("last") - (Double) o1.get("open");
                Double change2 = o2.containsKey("change") ?
                        (Double) o2.get("change") : (Double) o2.get("last") - (Double) o2.get("open");

                return Double.compare(change2,change1);
            }
        });
        list.sort((o1, o2) -> ((Date) o2.get("date")).compareTo((Date) o1.get("date")));
        list.sort(Comparator.comparing(stock -> ((String) stock.get("name"))));
