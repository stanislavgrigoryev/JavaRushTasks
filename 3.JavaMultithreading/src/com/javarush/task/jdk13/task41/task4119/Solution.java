...
import com.javarush.task.jdk13.task41.task4119.strategy.CashStrategy;
import com.javarush.task.jdk13.task41.task4119.strategy.CreditCardStrategy;
import com.javarush.task.jdk13.task41.task4119.strategy.PaypalStrategy;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        ShoppingCart cart1 = new ShoppingCart(new CreditCardStrategy(customer));
        cart1.addItem(new Item(847, "Электрическая зубная щетка", 12));
        cart1.addItem(new Item(939, "Триммер", 19));
        cart1.pay();

        ShoppingCart cart2 = new ShoppingCart(new CashStrategy());
